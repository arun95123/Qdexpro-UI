...
import { actionOptions,waitTypeOptions } from './table.dropDownOptions'
...
class table extends React.Component{
  ...
  render() {
    return(
      ...
      <label className='left-window--form--content'>
        Ref Column
        <input placeholder='Column name' type="text" name="name" className='left-window--form--content--textbox'/>
      </label>
      <br />
      <label className='left-window--form--content'>
        Ref Cell Value
        <input placeholder='Cell value' type="text" name="name" className='left-window--form--content--textbox'/>
      </label>
      <br />
      <label className='left-window--form--content'>
        Return Column
        <input placeholder='Column' type="text" name="name" className='left-window--form--content--textbox'/>
      </label>
      <br />
      <label className='left-window--form--content'>
        Variable Name
        <input placeholder='Name' type="text" name="name" className='left-window--form--content--textbox'/>
      </label>
      <br/>
      <label className='left-window--form--content'>
