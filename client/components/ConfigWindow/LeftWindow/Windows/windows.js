...
import { actionOptions,waitTypeOptions } from './windows.dropDownOptions'
...
class windows extends React.Component{
  ...
  render() {
    return(
      ...
      <label className='left-window--form--content'>
        Window Name
        <input type="text" placeholder='Window Title' name="name" className='left-window--form--content--textbox'/>
      </label>
      <br />
      <label className='left-window--form--content'>
